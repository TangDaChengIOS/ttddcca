//
//  MoneyRecord_YH_ViewController.m
//  BeSiTe
//
...
@interface MoneyRecord_YH_ViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MoneyRecord_YH_ViewController
...
- (void)viewDidLoad {
    ...
    self.tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        weak_self.page = 1;
        [weak_self requestDataForYouHui];
    }];
...
-(void)requestDataForYouHui{
    [RequestManager getWithPath:@"getUserPromotionInfos" params:[self para] success:^(id JSON ,BOOL isSuccess) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setCellWithModel:self.dataSource[indexPath.row] andCellType:RecordCellType_YouHui];
...
{
    [ShowRecordDetailView showWithModel:self.dataSource[indexPath.row] andRecordType:RecordCellType_YouHui];
}
...
-(void)configSubViews{
    ...
    _headerView.cellType = RecordCellType_YouHui;
    [_headerView setTopCellWithVCType:RecordDetailControlType_YouHui];
